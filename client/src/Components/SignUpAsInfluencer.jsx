...
<div className="option-wrap ">  
      ...
      {selectedOption && (
        <p className="text-xs text-gray-500">Selected option: {selectedOption}</p>
      )}
    </div>
    <div className='mx-2'>
      <select
    ...
    <div className="socialaccounts mx-3 ">
        <p className=' cursor-pointer border-2 p-2 float-start rounded-md m-1.5  w-[15vw]'>Instagram</p>
        <p className=' cursor-pointer border-2 p-2 float-start rounded-md m-1.5 w-[15vw]'>Youtube</p>
        <p className=' cursor-pointer border-2 p-2 float-start rounded-md m-1.5 w-[15vw]'>Facebook</p>
        <p className=' cursor-pointer border-2 p-2 float-start rounded-md m-1.5 w-[15vw]'>Tiktok</p>
    </div>
